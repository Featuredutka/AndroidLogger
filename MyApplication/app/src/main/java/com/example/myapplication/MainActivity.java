...
public class MainActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (mGyro != null) {
      sensorManager.registerListener(MainActivity.this, mGyro,
                                     SensorManager.SENSOR_DELAY_NORMAL);
    ...
    if (mMagno != null) {
      sensorManager.registerListener(MainActivity.this, mMagno,
                                     SensorManager.SENSOR_DELAY_NORMAL);
    ...
    firstbutton.setOnClickListener(v -> {
      ...
      try {
        writer = new FileWriter(new File(
            getStorageDir(), "sensors_" + System.currentTimeMillis() + ".csv"));
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
      ...
      if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
        ...
        try {
          writer.write(String.format(
              ...
              sensorEvent.values[2], 0.f, 0.f, 0.f));
        } catch (IOException e) {
          e.printStackTrace();
        }
